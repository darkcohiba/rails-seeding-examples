...
class CohortsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cohort" do
    assert_difference("Cohort.count") do
      post cohorts_url, params: { cohort: { graduated: @cohort.graduated, title: @cohort.title } }, as: :json
    end
  ...
  test "should update cohort" do
    patch cohort_url(@cohort), params: { cohort: { graduated: @cohort.graduated, title: @cohort.title } }, as: :json
    assert_response :success
  end
